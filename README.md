...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/diffoscope-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/diffoscope-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add diffoscope diffoscope-all-tools
# for installing globally
pixi global install diffoscope diffoscope-all-tools
```
...
It is possible to list all of the versions of `diffoscope` available on your platform:
...
```
pixi search diffoscope --channel conda-forge
```
